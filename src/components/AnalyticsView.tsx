...
import { TrendingUp, TrendingDown, Target, Award, PieChart as PieIcon, BarChart3, Activity, ShieldCheck, ArrowUpRight } from 'lucide-react';
...
export const AnalyticsView: React.FC = () => {
  ...
  // Key metrics matching Section 18
  const metrics = [
  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto w-full pb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {metrics.map((m) => {
          ...
          return (
            <div
              key={m.label}
              className="bg-ui-surface rounded-2xl p-5 border border-ui-border shadow-sm flex flex-col justify-between"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-ui-surface rounded-2xl p-6 border border-ui-border shadow-sm space-y-4">
        ...
        <div className="bg-ui-surface rounded-2xl p-6 border border-ui-border shadow-sm space-y-4 flex flex-col justify-between">
          <div>
      ...
      <div className="bg-ui-surface rounded-2xl p-6 border border-ui-border shadow-sm space-y-6">
        <div>
