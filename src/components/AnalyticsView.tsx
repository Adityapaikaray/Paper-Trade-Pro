...
import { 
  ...
  Activity, ShieldCheck, ArrowUpRight, BarChart2
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-ui-border pb-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-text-muted uppercase tracking-wider">Portfolio Analytics</span>
        ...
        {/* Timeframes */}
        <div className="flex items-center bg-ui-surface p-1 rounded-xl border border-ui-border shadow-2xs self-start sm:self-auto">
