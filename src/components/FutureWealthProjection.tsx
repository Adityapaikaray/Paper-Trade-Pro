    ...
    <div className="bg-ui-surface border border-ui-border rounded-3xl p-6 md:p-10 shadow-lg">
      ...
      <div className="flex flex-col xl:flex-row gap-10">
        ...
        <div className="w-full xl:w-80 shrink-0 flex flex-col gap-6">
          <div className="space-y-4 bg-ui-bg p-5 rounded-2xl border border-ui-border">
            <h3 className="text-[11px] font-bold text-primary uppercase tracking-widest mb-2 border-b border-ui-border/50 pb-2">Projection Details</h3>
            ...
            <AnimatePresence mode="popLayout">
                  ...
                  {mode === 'SIP_LUMPSUM' && (
                    <div className="mt-2 flex flex-col gap-1.5">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        ...
                        />
                        <span className="text-[10px] font-bold text-text-main uppercase tracking-widest group-hover:text-primary transition-colors">
                          Use current portfolio value
                        </span>
                      </label>
                      <span className="text-[9px] font-bold text-text-muted pl-5 italic">
                        {useCurrentPortfolio 
                          ? 'Automatically using your latest portfolio value.' 
                          : 'Enter the starting lumpsum amount for this projection.'}
                      </span>
                    </div>
                  )}
                </motion.div>
              ...
              {mode !== 'LUMPSUM' && (
                <motion.div
                  ...
                  className="overflow-hidden"
                >
                  <label className="text-[11px] font-bold text-text-muted uppercase tracking-wider block mb-2 mt-1">Monthly SIP Amount</label>
            ...
            <div className="mt-1">
              ...
              <input 
                ...
                min="1" max="50" step="1"
              />
              <p className="text-[9px] text-text-muted font-bold tracking-widest uppercase mt-1.5 text-right">Maximum 50 years</p>
            </div>
      ...
      <div className="mt-8 pt-8 border-t border-ui-border">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-ui-bg p-5 rounded-2xl border border-ui-border flex flex-col justify-between">
            <div>
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-wider mb-2">Total Invested Amount</p>
          ...
          <div className="bg-ui-surface p-5 rounded-2xl border border-primary/30 flex flex-col justify-between shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-[10px] font-bold text-primary uppercase tracking-wider mb-2">Projected Future Value</p>
      ...
      {mode === 'SIP_LUMPSUM' && (
        <div className="mt-6 pt-6 border-t border-ui-border">
          <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-4">Projection Breakdown</p>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="p-3 bg-ui-surface rounded-xl border border-ui-border">
              <p className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1">Starting Portfolio</p>
              <p className="text-sm font-mono font-bold text-text-main">{formatCompactCurrency(parseFloat(projLumpsum) || 0)}</p>
            </div>
            <div className="p-3 bg-ui-surface rounded-xl border border-ui-border">
              <p className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1">Projected Growth of Starting Portfolio</p>
              <p className="text-sm font-mono font-bold text-positive">+{formatCompactCurrency(lumpsumGrowth)}</p>
            </div>
            <div className="p-3 bg-ui-surface rounded-xl border border-ui-border">
              <p className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1">Total SIP Contributions</p>
              <p className="text-sm font-mono font-bold text-text-main">{formatCompactCurrency(sipInvested)}</p>
            </div>
            <div className="p-3 bg-ui-surface rounded-xl border border-ui-border">
              <p className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1">Projected Growth from SIP</p>
